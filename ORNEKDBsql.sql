...
INSERT INTO USERS VALUES('hsynaatik','15975300','Huseyin Atik','hsynaatik@gmail.com','E','2002-05-25','','5442239645','5442239637')
INSERT INTO USERS VALUES('DENEME','15975300','DENEME Atik','deneme@gmail.com','K','2002-05-25','','5362239675','5374529631')
...
INSERT INTO CITIES VALUES(1,'ISTANBUL')

INSERT INTO TOWNS VALUES(1,'MAMAK')
INSERT INTO TOWNS VALUES(2,'IZNIK')
INSERT INTO TOWNS VALUES(3,'PENDIK')

INSERT INTO DISTRICTS VALUES(1,'YENIMAHALLE')
INSERT INTO DISTRICTS VALUES(2,'YESILCAMII')
INSERT INTO DISTRICTS VALUES(3,'TOPKAPI')

INSERT INTO ADRESS VALUES(2,1,2,1,1,'1524','ANKARA MAMAK')
INSERT INTO ADRESS VALUES(1,1,2,2,2,'16860','BURSA IZNIK')

INSERT INTO ORDERS VALUES(1,'2023-04-26',84.75,1,2)
INSERT INTO ORDERS VALUES(2,'2023-05-13',96.75,1,1)

INSERT INTO ITEMS VALUES(01,'G�MLEK',81.35,'ERKEK','UST GIYIM','PAMUK','GOMLEK','PUMA')
INSERT INTO ITEMS VALUES(02,'AYAKKABI',89.43,'ERKEK','ALT GIYIM','SPOR','BEYAZ','NIKE')
...
--KULLANICI ADI SOYADI IL ILCE SEMT ACIK ADRES SIPARIS ID TARIH TOPLAM TUTAR ODEME TARIHI BANKA ONAY KODU   FATURA TARIHI   KARGO FIS 
SELECT 
...
SUM(AMOUNT) TOPLAMMIKTAR,SUM(LINETOTAL)AS TOPLAMTUTAR,COUNT(OD.ID) URUNSAYISI,
